(function () {
	...
	function createPKCS10() {
		return Promise.resolve().then(() => createPKCS10Internal()).then(() => {
			...
			let priresultString = "-----BEGIN PRIVATE KEY-----\r\n";
			priresultString = `${priresultString}${formatPEM(window.btoa(privateKeyString))}`;
			priresultString = `${priresultString}\r\n-----END PRIVATE KEY-----\r\n`;
			
			document.getElementById("pri-text-block").innerHTML = priresultString;
